    ...
    <div class="card-body table-responsive p-0">
      <table class="table table-hover text-nowrap">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                data-bs-target="#detailsModal{{ $item->item_id }}">
                View
              </button>

              <!-- Modal -->
              <div class="modal fade" id="detailsModal{{ $item->item_id }}" tabindex="-1"
                aria-labelledby="detailsLabel{{ $item->item_id }}" aria-hidden="true">
          ...
          @empty
          <tr>
            <td colspan="6" class="text-center">No items found for this user in selected date range.</td>
          </tr>
          @endforelse
        </tbody>
      </table>
